...
Revision ID: 6c24970ed06d
Revises: 
Create Date: 2025-11-19 16:38:06.099377
...
def upgrade() -> None:
    ...
    sa.Column('logo_name', sa.String(), server_default='', nullable=False),
    ...
    sa.Column('templates_config', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('server_config', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['connector_id'], ['mcp_connectors.id'], ondelete='CASCADE'),
    ...
    sa.Column('template_args', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('tool', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('tool_type', sa.Enum('static', 'dynamic', name='tooltype'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['mcp_server_id'], ['mcp_servers.id'], ondelete='CASCADE'),
