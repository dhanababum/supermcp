...
def upgrade() -> None:
    ...
    op.add_column('mcp_server_tools', sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('mcp_server_tools', sa.Column('tool', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('mcp_server_tools', sa.Column('tool_type', tooltype_enum, nullable=False))
    op.add_column('mcp_server_tools', sa.Column('is_active', sa.Boolean(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('mcp_server_tools', sa.Column('tools', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True))
