...
def upgrade() -> None:
    ...
    op.alter_column(
        "mcp_servers", "connector_id", existing_type=sa.Integer(), nullable=False
    )
...
def downgrade() -> None:
    ...
    op.add_column("mcp_servers", sa.Column("connector_id", sa.VARCHAR(), nullable=True))
    ...
    op.alter_column(
        "mcp_servers", "connector_id", existing_type=sa.String(), nullable=False
    )
