...
def upgrade() -> None:
    ...
    op.add_column(
        "connector_access",
        sa.Column("connector_id_uuid", postgresql.UUID(as_uuid=True), nullable=True),
    )
    op.add_column(
        "mcp_servers",
        sa.Column("connector_id_uuid", postgresql.UUID(as_uuid=True), nullable=True),
    ...
    op.alter_column(
        "connector_access", "connector_id_uuid", new_column_name="connector_id"
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "connector_access", "connector_id", new_column_name="connector_id_uuid"
    )
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            nullable=False,
            server_default=sa.text("nextval('mcp_connectors_id_seq'::regclass)"),
        ),
    )
    op.add_column(
        "connector_access", sa.Column("connector_id", sa.INTEGER(), nullable=True)
    )
