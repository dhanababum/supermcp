...
const CompanyStats = () => {
  const stats = [
    { icon: '👥', iconBg: 'bg-purple-100', iconColor: 'text-purple-600', value: '2', label: 'Stakeholders', 
    ...
    { icon: '🧮', iconBg: 'bg-indigo-100', iconColor: 'text-indigo-600', value: '$2.63157', label: 'Share price',
