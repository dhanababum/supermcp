    ...
    <div className="lg:col-span-2 bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button className="px-6 py-2 bg-brand-600 text-white text-sm font-medium rounded-lg hover:bg-brand-700">
            Update
          </button>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-brand-600 to-brand-400" style={{ width: '0%' }}></div>
            </div>
            <div className="absolute left-0 top-0 h-2 w-0 border-l-2 border-brand-600"></div>
          </div>
          <div className="flex items-center justify-between text-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-brand-600 font-medium">23 days left</span>
          </div>
        </div>
      </div>
    </div>
